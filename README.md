...
While looking into local job markets, I noticed how common .NET was in the Michigan area, which led me down the path of learning it more seriously. From there, I chose to build a vehicle telemetry system since it aligned with the types of backend and full-stack roles I was seeing around me. I’ll be honest, the concept itself wasn’t something I was particularly passionate about, but I didn’t mind that—instead, I used it as a practical way to learn and build something relevant while improving my skills.
